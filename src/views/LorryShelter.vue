...
export default defineComponent({
  ...
  mounted() {
    ...
    let building = BABYLON.SceneLoader.ImportMesh('', './models/buildings/lorry-shelter/', 'lorry-shelter.gltf', scene, (meshes) => {
      meshes[0].scaling = new BABYLON.Vector3(this.zoomFactor * this.length / 10, this.zoomFactor * this.height / 10, this.zoomFactor * this.width / this.widthOffset)
  ...
  methods: {
    ...
    dimensionChange(val, dir) {
      ...
      this.rootMesh.scaling = new BABYLON.Vector3(this.zoomFactor * this.length / 10, this.zoomFactor * this.height / 10, this.zoomFactor * this.width / this.widthOffset)
